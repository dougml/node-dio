const player1 = {
  ...
  async function playRaceEngine(character1, character2) {
    for (let round = 1; round <= 5; round++) {
      ...
      let mode = block === "CONFRONTO" ? await sortMode() : null;
      if (mode) {
        console.log(`Modo de Confronto: ${mode}`);
      }
        ...
        if (powerResult1 > powerResult2) {
          if (mode === 'Casco') {
            ...
            if (character2.PONTOS > 1) {
              ...
              character2.PONTOS = 0;
              console.log(
                `${character1.NOME} venceu o confronto com uma Bomba! ${character2.NOME} perdeu todos os pontos 💣`
              );
            }
          }
          character1.PONTOS++;
          ...
          if (mode === 'Casco') {
            ...
            if (character1.PONTOS > 1) {
              ...
              character1.PONTOS = 0;
              console.log(
                `${character2.NOME} venceu o confronto com uma Bomba! ${character1.NOME} perdeu todos os pontos 💣`
              );
            }
          }
          character2.PONTOS++;
